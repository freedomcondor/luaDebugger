...
function debug.step(event, line)
	print("i am debug step")
end

function step(event, line)
	print("event = ",event)
	if event == "return" then
		print("i am a return = ",event)
		return nil
	end

	if event == "call" then
		print("i am a call = ",event)
		return nil
	end
...
--function debugger(mainfile)
local s = debug.getinfo(1)
DEBUGGERVAR.focalfunc = nil
--print("s.name",s.short_src)
